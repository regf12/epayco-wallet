        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li v-if="user" class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              ...
              <router-link v-if="user.type!='ADMIN'" :to="{ name: 'operations.pay' }" class="dropdown-item pl-3">
                <fa icon="credit-card" fixed-width />
                {{ $t('operations') }}
              </router-link>

              <div class="dropdown-divider" v-if="user.type!='ADMIN'" />
